...
const ProfilePic = ({
  ...
  const transitionFrom = showMobileResponsive
    ? "translate(calc(75px - 50vw), calc(50vh - 100px)) scale(1)"
    : "translate(calc(75px - 50vw), calc(50vh - 100px)) scale(1)";
  const transitionTo = showMobileResponsive
    ? "translate(calc(75px - 50vw), calc(50vh - 255px)) scale(1)"
    : "translate(calc(75px - 50vw), calc(50vh - 250px)) scale(1)";

  const springTranslateFrom = showMobileResponsive
    ? "translate(calc(75px - 50vw), calc(50vh - 255px)) scale(1)"
    : "translate(calc(75px - 50vw), calc(50vh - 250px)) scale(1)";
  const springTranslateTo = showMobileResponsive
    ? "translate(calc(-40px - 0vw), calc(0vh - -10px)) scale(0.3)"
    : "translate(calc(-40px - 0vw), calc(0vh - -10px)) scale(0.25)"; // only difference is scale value

  const shadowFrom = showMobileResponsive
    ? "0px 3px 12px 2px rgba(0, 0, 0, 0.35)"
    : "0px 5px 12px 3px rgba(0, 0, 0, 0.35)";
  const shadowTo = showMobileResponsive
    ? "0px 3px 12px 2px rgba(0, 0, 0, 0)"
    ...
    ({ item, props: transitionProps }) =>
      item && (
        <animated.img
          ...
          src={profilePic}
          className={`${styles.user_pic} user_pic ${
